...
Partial Class FormLogin
    ...
    Private Sub InitializeComponent()
        ...
        btnGoToRegister = New Guna.UI2.WinForms.Guna2Button()
        ...
        btnLogin.Location = New Point(48, 336)
        ...
        btnGoToRegister.CustomizableEdges = CustomizableEdges5
        btnGoToRegister.FillColor = Color.Transparent
        btnGoToRegister.Font = New Font("JetBrains Mono", 8.999999F, FontStyle.Underline)
        btnGoToRegister.ForeColor = Color.FromArgb(CByte(45), CByte(53), CByte(73))
        btnGoToRegister.Location = New Point(48, 408)
        btnGoToRegister.Name = "btnGoToRegister"
        btnGoToRegister.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        btnGoToRegister.Size = New Size(288, 25)
        btnGoToRegister.TabIndex = 4
        btnGoToRegister.Text = "Belum memiliki akun? Register"
        ' 
        ' pnlCard
        ' 
    ...
    Friend WithEvents btnGoToRegister As Guna.UI2.WinForms.Guna2Button
